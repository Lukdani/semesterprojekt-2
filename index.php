...
<!-- <div id="carouselExampleCaptions" class="carousel slide" data-bs-ride="carousel">
  ...
  <div class="carousel-inner .overlay-container">
	  <div class="overlay overlay--subtle bg-green"></div>
    <div class="carousel-item active">
      <img src="./images/langhuset_hero.jpg" class="d-block w-100" alt="...">
      <div class="carousel-caption d-none d-md-block overlay-text">
	  <div class="carousel-text-container">
        <h5>Familie og grupper</h5>
        <p>Skal du holde børnefødselsdag, firmaarragement, klubtur eller andet? <br> Så hold dit næste arragement i Vikingeborgen Trelleborg. </p>
    ...
    <div class="carousel-item">
      <img src="./images/skilt_hero.jpg" class="d-block w-100" alt="...">
    ...
    <div class="carousel-item">
      <img src="./images/foto_hero.jpg" class="d-block w-100" alt="...">
  ...
  <button class="carousel-control-next" type="button" data-bs-target="#carouselExampleCaptions" data-bs-slide="next">
    ...
    <span class="visually-hidden">Next</span>
	  ...
	  <div class="row featureBox-container overlay-container">
...
<div class="row">
	<div class="col col-lg-7 col-12 textContainer textContainer">
