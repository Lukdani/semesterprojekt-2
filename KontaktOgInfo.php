    ...
    <div class="container-fluid p-0">
        ...
        <div class="row contentBox-container featuresBox overlay-container">
            <div class="col-12">
                                    ...
                                    <div class="covidInfo">
                                        <div class="row">
                                            ...
                                            <div class="col col-12 col-lg-7">
                                                ...
                                                eller
                                                <strong>negativ coronatest</strong> som er max må være 72 timer gammel,
                                                samt
                                                <strong>gyldigt
                                                    ID</strong>.
                                                <br>
                ...
                <div class="row praktiskInfo ">
                    <div class="col col-12 col-lg-10 offset-lg-1 overlay-text">
                ...
                <div class="row kontaktGrid-row">
                    ...
                    <div class="col col-12 col-lg-6">
                        <div class="row">
                            ...
                            <div class="col col-12 col-lg-6">
                                <div class="card">
                                    <img src="./images/kontakt/mand2.png" class="card-img-top"
                                        alt="Kim Hoffmann-Madsen">
                                    <div class="card-body">
