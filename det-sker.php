                ...
                <div class="card article">
                    ...
                    <div class="card-body bg-light">
                        ...
                        <p class="card-text"> Tilbage i vikingeernes tid, fejrede man sommer solhvervet, med en storslået fest.
                            ...
                            <strong>Fortiden møder nutiden</strong> når vi kombinerer gamle traditioner fra midsommerfesten, med en hyggelig afsluttende afbrænding af vores Sankt Hans bål.
            ...
            <div class="col-12 col-md-6 col-xl-6">
                ...
                <div class="card article">
                    ...
                    <div class="card-body bg-light">
                        ...
                        <br>
                        <p class="article-details">"Smag en lille tår af Danmarkshistorien."</p>
                        </p>
                    </div>
                </div>
            </div>
            ...
            <div class="col-12 col-md-6 col-xl-6">
                ...
                <div class="card article">
                    ...
                    <div class="card-body bg-light">
                        ...
                        <br>
                        <p class="article-details">"Kom helt tæt på, og oplev hverdagslivet for en viking"</p>
                        </p>
                    </div>
                </div>
            </div>
            ...
            <div class="col-12 col-md-6 col-xl-6">
                ...
                <div class="card article">
                    ...
                    <div class="card-body bg-light">
                        ...
                        <br>
                        <p class="article-details">"Saml alle dine bedste krigere og drag på togt med vikingerne fra Trelleborg"</p>
                        </p>
                    </div>
                </div>
            </div>
